...
namespace Microsoft.Health.Fhir.S3Storage.Features.Storage
{
    ...
    public sealed class S3StorageFhirModel : IDisposable
    {
        ...
        public S3StorageFhirModel(
            S3StorageDataStoreConfiguration configuration,
            S3SchemaInformation schemaInformation,
            ISearchParameterDefinitionManager searchParameterDefinitionManager,
            IOptions<SecurityConfiguration> securityConfiguration,
            ILogger<S3StorageFhirModel> logger)
        {
        ...
        private async Task Initialize()
        {
            ...
            {
                _logger.LogError($"The current version of the database is not available. Unable in initialize {nameof(S3StorageFhirModel)}.");
        ...
        private void ThrowIfNotInitialized()
        {
            ...
            {
                _logger.LogError($"The {nameof(S3StorageFhirModel)} instance has not been initialized.");
                throw new ServiceUnavailableException();
            }
        }
