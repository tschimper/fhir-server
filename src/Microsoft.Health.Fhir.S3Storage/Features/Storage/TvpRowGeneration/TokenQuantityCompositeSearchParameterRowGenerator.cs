...
namespace Microsoft.Health.Fhir.S3Storage.Features.Storage.TvpRowGeneration
{
    internal class TokenQuantityCompositeSearchParameterRowGenerator : CompositeSearchParameterRowGenerator<(TokenSearchValue component1, QuantitySearchValue component2), V1.TokenQuantityCompositeSearchParamTableTypeRow>
    {
        ...
        public TokenQuantityCompositeSearchParameterRowGenerator(S3StorageFhirModel model, TokenSearchParameterRowGenerator tokenRowGenerator, QuantitySearchParameterRowGenerator quantityRowGenerator)
            : base(model)
        {
