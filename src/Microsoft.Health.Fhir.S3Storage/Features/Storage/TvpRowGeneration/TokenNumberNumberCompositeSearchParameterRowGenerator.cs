...
namespace Microsoft.Health.Fhir.S3Storage.Features.Storage.TvpRowGeneration
{
    internal class TokenNumberNumberCompositeSearchParameterRowGenerator : CompositeSearchParameterRowGenerator<(TokenSearchValue component1, NumberSearchValue component2, NumberSearchValue component3), V1.TokenNumberNumberCompositeSearchParamTableTypeRow>
    {
        ...
        public TokenNumberNumberCompositeSearchParameterRowGenerator(S3StorageFhirModel model, TokenSearchParameterRowGenerator tokenRowGenerator, NumberSearchParameterRowGenerator numberRowGenerator)
            : base(model)
        {
