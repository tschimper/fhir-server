...
namespace Microsoft.Health.Fhir.S3Storage.Features.Storage.TvpRowGeneration
{
    internal class TokenStringCompositeSearchParameterRowGenerator : CompositeSearchParameterRowGenerator<(TokenSearchValue component1, StringSearchValue component2), V1.TokenStringCompositeSearchParamTableTypeRow>
    {
        ...
        public TokenStringCompositeSearchParameterRowGenerator(S3StorageFhirModel model, TokenSearchParameterRowGenerator tokenRowGenerator, StringSearchParameterRowGenerator stringRowGenerator)
            : base(model)
        {
