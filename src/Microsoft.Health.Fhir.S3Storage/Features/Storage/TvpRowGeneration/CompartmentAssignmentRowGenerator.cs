...
{
    internal class CompartmentAssignmentRowGenerator : ITableValuedParameterRowGenerator<S3ResourceMetadata, V1.CompartmentAssignmentTableTypeRow>
    {
        ...
        public CompartmentAssignmentRowGenerator(S3StorageFhirModel model)
        {
            EnsureArg.IsNotNull(model, nameof(model));
            _model = model;
        }

        public IEnumerable<V1.CompartmentAssignmentTableTypeRow> GenerateRows(S3ResourceMetadata resourceMetadata)
        {
            EnsureInitialized();
