...
namespace Microsoft.Health.Fhir.S3Storage.Features.Storage.TvpRowGeneration
{
    internal class TokenDateTimeCompositeSearchParameterRowGenerator : CompositeSearchParameterRowGenerator<(TokenSearchValue component1, DateTimeSearchValue component2), V1.TokenDateTimeCompositeSearchParamTableTypeRow>
    {
        ...
        public TokenDateTimeCompositeSearchParameterRowGenerator(S3StorageFhirModel model, TokenSearchParameterRowGenerator tokenRowGenerator, DateTimeSearchParameterRowGenerator dateTimeRowGenerator)
            : base(model)
        {
