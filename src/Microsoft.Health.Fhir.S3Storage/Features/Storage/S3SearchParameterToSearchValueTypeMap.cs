...
namespace Microsoft.Health.Fhir.S3Storage.Features.Storage
{
    ...
    /// </summary>
    internal class S3SearchParameterToSearchValueTypeMap
    {
        ...
        public S3SearchParameterToSearchValueTypeMap(ISearchParameterDefinitionManager searchParameterDefinitionManager)
        {
