...
namespace Microsoft.Health.Fhir.S3Storage.Features.Search.Expressions.Visitors
{
    ...
    /// column is not null.
    /// </summary>
    internal class S3StringOverflowRewriter : ConcatenationRewriter
    {
        private readonly ISearchParameterDefinitionManager _searchParameterDefinitionManager;

        public S3StringOverflowRewriter(ISearchParameterDefinitionManager searchParameterDefinitionManager)
        ...
        public override Expression VisitString(StringExpression expression, object context)
        {
            ...
            return new StringExpression(expression.StringOperator, S3SqlFieldName.TextOverflow, expression.ComponentIndex, expression.Value, expression.IgnoreCase);
        }
