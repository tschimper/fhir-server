...
namespace Microsoft.Health.Fhir.S3Storage.Features.Search.Expressions.Visitors
{
    ...
    /// </summary>
    internal class S3NormalizedSearchParameterQueryGeneratorFactory : IExpressionVisitorWithInitialContext<object, NormalizedSearchParameterQueryGenerator>
    {
        private readonly S3SearchParameterToSearchValueTypeMap _searchParameterToSearchValueTypeMap;
        ...
        public S3NormalizedSearchParameterQueryGeneratorFactory(S3SearchParameterToSearchValueTypeMap searchParameterToSearchValueTypeMap)
        {
